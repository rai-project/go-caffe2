...
// #cgo linux,amd64 linux,arm64 CXXFLAGS: -I/opt/frameworks/caffe2/include -DWITH_GPU=1 -DWITH_CUDA=1 -I/usr/local/cuda/include
// #cgo linux,amd64 linux,arm64 LDFLAGS: -L/opt/frameworks/caffe2/lib -L/usr/local/cuda/lib64 -lCaffe2_GPU -lcurand -lcudart
